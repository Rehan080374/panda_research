...
class Classifier:
    ...
    def __init__(self, modelPath, labelsPath=None):
        ...
        # self.data = np.ndarray(shape=(1, 600, 300, 3), dtype=np.float32)
    ...
    def getPrediction(self, img, draw= True, pos=(50, 50), scale=2, color = (33,255,0)):
        # resize the image to a 224x224 with the same strategy as in TM2:
        imgS = cv2.resize(img, (224, 224))
        # imgS = cv2.resize(img, (300, 600))
...
def main():
    ...
    maskClassifier = Classifier('/home/rehan/catkin_ws/src/panda_research/hand_classifier/model/keras_model.h5', '/home/rehan/catkin_ws/src/panda_research/hand_classifier/model/labels.txt')
    while True:
        _, img = cap.read()
